...
#ifndef scriptcallbackhandler_h
#define scriptcallbackhandler_h
...
public:
    ...
    /**
     * Create an implementation from an object type definition (moved to ScriptThread)
     */
    ...
    */
    ...
    /**
    * Create a JavaScript object to pass back to V8 (moved to ScriptThread)
    */
